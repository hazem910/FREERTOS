...
/*******Sprint 2 *********/
#define TASK_A_PRIORITY                     2   /* 3 for story-1 ... 2 for story-2 */
#define TASK_B_PRIORITY                     3   /* 2 for story-1 ... 3 for story-2 */
#define TASK_C_PRIORITY                     4   /* 1 for story-1 ... 4 for story-2 */
#define TASK_D_PRIORITY                     5
/***************************************************************************/
...
void Init_task(void)
{
	...
	xReturned = xTaskCreate(
			       Sprint2_story2_Init,    		 /* Function that implements the task. */
...
void tasks_creation(void)
{
	...
	/* Create the task and storing the handle */
	xReturned = xTaskCreate(
		        	Sprint2_Story2_Task_A,    	 /* Function that implements the task. */
	...
	xReturned = xTaskCreate(
		           	Sprint2_Story2_Task_B,    	 /* Function that implements the task. */
	...
	xReturned = xTaskCreate(
			       Sprint2_Story2_Task_C,    	 /* Function that implements the task. */
	...
	xReturned = xTaskCreate(
					Sprint2_Story2_Task_D,    	 /* Function that implements the task. */
					"Task_D",                    /* Text name for the task. */
					STACK_SIZE5,     			 /* Stack size in words, not bytes. */
					NONE_PASSED_PARAMETER,    	 /* Parameter passed into the task. */
					TASK_D_PRIORITY,  	    	 /* Priority at which the task is created. */
					&Task_D_Handle );            /* Used to pass out the created task's handle. */
}
